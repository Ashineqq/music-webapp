...
<template>
<div class="flex flex-col items-center fixed bottom-0 right-0 left-0 h-[75vh] z-20 bg-white rounded-t-[20px] px-4 py-2 " v-if="collectToCreateVisible" ref="componentRef">
  <!-- 标头 -->

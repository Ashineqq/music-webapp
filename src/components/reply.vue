...
const getReplyHandle = async () => {
  const {
    data: { data },
  } = await getReply(commentParent.value.commentId, id.value);
  console.log(data);
...
<template>
  <div
    class="flex flex-col w-full h-[93vh] rounded-t-[20px] z-20 bg-white"
    ref="componentRef"
  >
    <!-- 回复title -->
    ...
    <div class="flex flex-col justify-center px-4 py-4">
      ...
      <div class="flex flex-col">
        <p class="text-[#3f3f43] text-[15px] font-sans">

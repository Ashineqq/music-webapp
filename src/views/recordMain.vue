...
<div class="flex flex-col bg-gradient-to-b from-[#6f894e] to-[#2d371e] h-screen w-screen" 
  v-if="item">
  <!-- 顶部 -->
  <div class="flex justify-between items-center pt-8 px-4">
    <img src="../assets/return.svg" alt="" class=" w-4" @click="router.back()">
    <p class=" text-[#b9c0b0] text-[14px]">新歌新碟</p>
    <p></p>
  </div>
  <!-- 旋转播放 -->
  <div class="flex justify-center items-center flex-8">
    <img :src="item.picUrl" alt="" class=" w-[80vw] rounded-full animate-[spin_10s_linear_infinite]">
  </div>
  <!-- 信息喜欢评论 -->
  <div class="flex items-center justify-between px-4 flex-3">
    ...
    <div class=" flex space-x-4 ">
      <img src="../assets/like.svg" alt="" class=" w-6 " @click.stop="toCollectHandle()">
      <img src="../assets/comment.svg" alt="" class=" w-5" @click="toCommentHandle(item.id)">
    </div>
  </div>
  <!-- 进度条 -->
  ...
  <div class=" flex justify-between mb-8">
    ...
    <img src="../assets/record2.svg" alt="" class=" w-8" @click="" ref="toggoleRef">

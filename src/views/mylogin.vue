...
<template>
  <body
    class="bg-white flex flex-col justify-center items-center w-[100vw] h-[100vh] bg-gradient-to-b from-red-50 to-white"
  >
    <!-- Logo and guest-->
    <div class="grid grid-rows-6 grid-cols-7 basis-3/5 pt-[20px]">
      <div class="col-start-7 text-gray-400" @click="guestToLayoutHandle">
        Guest
      </div>
      <img
        src="../assets/logo.svg"
        alt=""
        class="row-start-3 col-start-4 h-12 w-12 rounded-full"
      />
    </div>
    ...
    <div class="basis-2/5 flex flex-col justify-center items-center">
      <!-- 手机号码输入 -->
      <div
        class="mx-[20px] w-[80%] mb-4 flex items-center bg-gray-100 rounded-lg p-3 shadow-sm"
      >
      ...
      <button
        @:click="loginHandle"
        class="mx-[20px] w-[80%] bg-red-500 text-white py-3 rounded-full"
      >
        登录
      </button>
